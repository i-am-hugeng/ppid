    ...
    (function (e, t) {
        ...
        class lt {
            ...
            handleKey(e) {
                ...
                if (n) {
                    ...
                    switch (
                        ([
                            32, 37, 38, 39, 40, 48, 49, 50, 51, 52, 53, 54, 56,
                            57, 67, 70, 73, 75, 76, 77, 79,
                        ].includes(s) &&
        ...
        const ht = {
            ...
            ready() {
                ...
                W(l) &&
                    (l = e.media.getAttribute(e.config.attributes.embed.id));
                const o = W((r = l))
                    ? null
                    : $(Number(r))
                    ? r
