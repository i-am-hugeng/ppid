...
dtOtherInformation();
function dtOtherInformation() {
    $("#dtOtherInformation").DataTable({
        ordering: true,
        info: true,
        autoWidth: false,
        responsive: true,
        ...
        serverSide: true,
        ajax: {
            url: "/admin/public-information/other-information-list",
            type: "GET",
        },
        dom: "Bfrtip",
        columns: [
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                dataType: "JSON",
                url: "/admin/public-information/other-information-list/add",
                contentType: false,
                processData: false,
                cache: false,
                ...
                success: function (response) {
                    Toast.fire({
                        icon: "success",
                        title: "Data daftar informasi lainnya berhasil tersimpan.",
                    });
                },
                ...
                complete: function (response) {
                    ...
                    $("#dtOtherInformation").DataTable().ajax.reload();
                },
            });
        },
    });
...
$(document).on("click", ".edit", function () {
    ...
    $.ajax({
        type: "GET",
        url:
            "/admin/public-information/other-information-list/modal-edit/" + id,
        success: function (response) {
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                url:
                    "/admin/public-information/other-information-list/edit/" +
                    id,
                contentType: false,
                processData: false,
                cache: false,
                ...
                success: function (response) {
                    Toast.fire({
                        icon: "success",
                        title: "Data daftar informasi lainnya berhasil diubah.",
                    });
                },
                error: function (response) {
                    Toast.fire({
...
$(document).on("click", ".delete", function () {
    ...
    $.ajax({
        type: "GET",
        url:
            "/admin/public-information/other-information-list/modal-delete/" +
            id,
        success: function (response) {
            // Get data category from response json
            $("#delete-id").val(response.dataDelete.id);
            $(".card-body-delete").append(
                "<p>Anda yakin untuk menghapus informasi lainnya : <strong>" +
                    '"' +
...
$("#form-delete").on("submit", function (e) {
    ...
    $.ajax({
        type: "DELETE",
        url: "/admin/public-information/other-information-list/delete/" + id,
        success: function (response) {
            Toast.fire({
                icon: "success",
                title: "Berhasil hapus informasi lainnya.",
            });
